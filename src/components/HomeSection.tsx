        ...
        <>
            ...
            > 
                ...
                <div className="flex flex-col items-center text-center mt-[6%]">
                    ...
                    />
                    <h2 className="text-2xl md:text-[40px] text-green-400 tracking-[-1.5px]">
                        Desarrollador Web FullStack
                    </h2>

                    <div className="mt-[4%] flex flex-col items-center gap-y-4 md:flex-row md:justify-center md:gap-[5%]">
                    ...
                    <span className='w-[90%] mt-[4%] flex items-center justify-center'>
                        <p className="text-3xl text-white-700">
                            Especializado en
                        </p>
                        <RotatingText
                            texts={['React.JS', 'Next.JS', 'TailwindCSS', 'MongoDB', 'TypeScript']}
                            mainClassName="text-3xl px-1 sm:px-1 md:px-2 text-white overflow-hidden justify-center"
                            staggerFrom={"last"}
                            initial={{ y: "100%" }}
                            animate={{ y: 0 }}
                            exit={{ y: "-120%" }}
